...
initialize_query_table()
{
  ...
  emplace_sysfs_getput<query::ert_cq_read>                   ("ert_user", "cq_read_cnt");
  emplace_sysfs_getput<query::ert_cq_write>                  ("ert_user", "cq_write_cnt");
  emplace_sysfs_getput<query::ert_cu_read>                   ("ert_user", "cu_read_cnt");
  emplace_sysfs_getput<query::ert_cu_write>                  ("ert_user", "cu_write_cnt");
